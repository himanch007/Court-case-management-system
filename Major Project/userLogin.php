...
<div class="login-box">
  ...
  <a id="registration" href="userRegistration.php">User Registration</a>
<br><br>
...
$stmt = $conn->prepare("select eid,ename,password from user where ename=?");
